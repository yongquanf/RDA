...
public class ParallelSBFInsert2 {
	  ...
	  public void init(){
	    ...
	    public ParallelSBFInsert2(int bfNum) {
	   ...
	   Iterator<Key> ier = (keyList.iterator());
		...
		write("testSBFParallelInsert", result);
		return T3;
}
	   ...
	   public void write(String testParallelInsert,String result){
		   
		   BufferedWriter bufferedWriter = null;
			try{
			
				bufferedWriter = new BufferedWriter(new FileWriter(testParallelInsert,true));
		 ...
		 public static void  main(String[]args){
			 ...
			 try {
				 ...
				 ParallelSBFInsert2 bf = new ParallelSBFInsert2(1); 
				 bf.buildBF();
				 bf.sequentialTest(hashKeys.get(0));	
				 //bf.clean();
				 for(int i=1;i<=4;i++){
				 
					 bf = new ParallelSBFInsert2(i); 
					 bf.buildBF();
