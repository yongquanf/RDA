...
public class ParallelSBFQuery2 {
	  ...
	  public void init(){
	    ...
	    public ParallelSBFQuery2(int bfNum) {
	   ...
	   Iterator<Key> ier = (keyList.iterator());
		...
		write("testSBFParallelQuery", result);
		return T3;
}
	   ...
	   public void write(String testParallel,String result){
		 ...
		 public static void  main(String[]args){
			 ...
			 try {
				 ...
				 ParallelSBFQuery2 bf = new ParallelSBFQuery2(1); 
				 bf.buildBF();
				 bf.sequentialTest(hashKeys.get(0));	
				 //bf.clean();
				 for(int i=1;i<=4;i++){
				 
					 bf = new ParallelSBFQuery2(i); 
					 bf.buildBF();
